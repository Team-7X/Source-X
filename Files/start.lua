...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " X"
SudosS = {1812710615}
Sudos = {sudoid,1812710615}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
{{text = ' 🇱🇾 ┇ تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "X"),data="delnamebot"}},
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/XQQAQ&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعة" then
bot.sendText(msg.chat_id,msg.id,"*  🇱🇾 ┇الساعة الان : ( "..os.date("%I:%M%p").." )*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "X"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "X"),"اني لقميل "..(redis:get(bot_id..":namebot") or "X"),(redis:get(bot_id..":namebot") or "X").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "X") then
...
local UserId_Info = bot.searchPublicChat("XQQCQ")
if UserId_Info.id then
...
local Text = "*ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ X\n\n*[ 🇱🇾 ┇  X ᴄʜᴀɴɴᴇʟ](http://t.me/XQQAQ)*\n\n*[ 🇱🇾 ┇  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/XQQAQ)*\n\n*[ 🇱🇾 ┇  X ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/XQQCQ)*\n\n*[ 🇱🇾 ┇  ʙᴏᴛ X](http://t.me/XQQAQ)*\n*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 X ',url="t.me/XQQAQ"}
