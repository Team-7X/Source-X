...
Sudos = {sudoid,1812710615,1812710615}
Sudo_Id = 1812710615
function Bot(msg)  
local idbot = false  
...
if text == "/start" then 
local bl = '*◾أهلا بك في صانع بوتات الحماية 👋🏻 ،\n\n◽البوت مقدم من قناة »* [. 𝖲𝗈𝗎𝗋𝖼𝖾 yousef TeAm >](t.me/XQQAQ) \n\n*◾يمكنك الان صنع بوت واحد فقط من صانع البوتات\n\n     عليك استخدام اوامر التحكم اسفل وبدء الانشاء🔻\n⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯*\n[⚙️꒐ Gruop The Suport Maker .](https://t.me/XQQAQ)'
...
- تم انشاء الصانع مقدم من قناة ( @XQQAQ ) مجاناً 
...
*⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯
- قناة شروحات السورس : @XQQAQ .
- بوت تواصل دعم السورس : @XQQAQ .*
